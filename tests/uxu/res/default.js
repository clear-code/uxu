...
pref("uxu.test.default.pref.comment1", true); // comment after pref
pref("uxu.test.default.pref.comment2", true); /* comment after pref */
pref("uxu.test.default.pref.comment3", true); /* comment after pref
                                                 multiline */
